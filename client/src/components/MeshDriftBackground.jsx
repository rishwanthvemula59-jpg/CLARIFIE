...
export const PlasmaBackground = () => {
  ...
  useEffect(() => {
    ...
    if (!gl) {
      console.warn('WebGL1 not supported in this browser environment.');
      return;
    }
    ...
    // Pure Deep Black & Charcoal Silk Palette
    const paletteColors = new Float32Array([
      0.000, 0.000, 0.000, // #000000 (Pure Pitch Black)
      0.020, 0.020, 0.020, // #050505 (Ultra-Dark Onyx)
      0.051, 0.051, 0.063, // #0D0D10 (Subtle Charcoal)
      0.094, 0.094, 0.122, // #18181F (Soft Dark Slate)
      0.000, 0.000, 0.000,
      0.020, 0.020, 0.020,
      0.051, 0.051, 0.063,
      0.094, 0.094, 0.122
    ...
    gl.uniform3fv(uColorsLoc, paletteColors);
    gl.uniform4f(uShapeLoc, 1.40, 0.15, 0.40, 0.00); // Soft, non-distracting wave movement
    gl.uniform4f(uSurfaceLoc, 2.00, 0.90, 0.00, 1.00); // Zero harsh glare
    gl.uniform4f(uFinishLoc, 0.00, 0.60, 0.005, 0.00); // Zero film grain, rich edge vignette
    gl.uniform4f(uTransformLoc, 7.0, 0.00, 0.25, 0.0);
    gl.uniform4f(uSpaceLoc, 0.00, 0.00, 0.0, 0.0);
    gl.uniform4f(uCursorLoc, 0.0, 2.0, 0.65, 0.30); // Cursor off
    ...
    const render = () => {
      ...
      gl.uniform4f(uSceneLoc, canvas.width, canvas.height, elapsedSeconds * 0.25, 4.0);
